...
<head>
    ...
    <title>Edit Supplier - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <style>
        ...
        /* Custom Styles for Supplier Form */
        .supplier-form-card {
            background-color: #ffffff;
            border-radius: 1rem;
            padding: 2rem;
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Edit Supplier</a>
                <ul class="navbar-nav">
        ...
        <!-- Edit Supplier Form Content -->
        <div class="container-fluid">
            <div class="supplier-form-card">
                <h3 class="mb-4">Edit Supplier Details</h3>
                <form action="process_edit_supplier.php" method="POST"> <!-- Action should point to a PHP script that processes the update -->
                    <!-- Hidden input for supplier ID to identify which supplier is being edited -->
                    <input type="hidden" name="supplier_id" value="1"> <!-- Replace with dynamic PHP value e.g., <?php echo htmlspecialchars($supplier['supplier_id']); ?> -->

                    <div class="mb-3">
                        <label for="supplier_name" class="form-label">Supplier Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="supplier_name" name="supplier_name" placeholder="e.g., Fresh Produce Inc." value="Fresh Harvest Farms" required> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                        <label for="contact_person" class="form-label">Contact Person</label>
                        <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="e.g., John Smith" value="Alice Johnson"> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="phone_number" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" id="phone_number" name="phone_number" placeholder="e.g., +1 (555) 123-4567" value="+1 (555) 123-4567"> <!-- Replace with dynamic PHP value -->
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="e.g., info@supplier.com" value="alice@freshharvest.com"> <!-- Replace with dynamic PHP value -->
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="address" class="form-label">Address</label>
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter supplier address">123 Farm Rd, Rural Town, USA</textarea> <!-- Replace with dynamic PHP value -->
                    </div>

                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-save me-2"></i> Update Supplier</button>
