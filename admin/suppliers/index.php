...
<head>
    ...
    <title>Supplier Management - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <style>
        ...
        /* Custom Styles for Supplier Table */
        .supplier-table-card {
            background-color: #ffffff;
            border-radius: 1rem;
            padding: 1.5rem;
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Supplier Management</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="supplier-table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3>All Suppliers</h3>
                    <a href="add.php" class="btn btn-add-supplier">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <input type="text" class="form-control form-control-sm" placeholder="Search suppliers by name, contact person, or email...">
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>alice@freshharvest.com</td>
                                <td>123 Farm Rd, Rural Town, USA</td>
                                <td>
                                    <a href="edit.php?id=1" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Delete</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td>bob@dairydelights.com</td>
                                <td>45 Dairy Lane, Milkville, USA</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>charlie@bakerybliss.com</td>
                                <td>789 Bread St, Bake City, USA</td>
                                <td>
