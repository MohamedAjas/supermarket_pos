...
<head>
    ...
    <title>Add New Supplier - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Add New Supplier</a>
                <ul class="navbar-nav">
        ...
        <!-- Add New Supplier Form Content -->
        <div class="container-fluid">
            <div class="supplier-form-card">
                <h3 class="mb-4">Supplier Details</h3>
                <form action="process_add_supplier.php" method="POST"> <!-- Action should point to a PHP script that processes the form -->
                    <div class="mb-3">
                        <label for="supplier_name" class="form-label">Supplier Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="supplier_name" name="supplier_name" placeholder="e.g., Fresh Produce Inc." required>
                    </div>
                    <div class="mb-3">
                        <label for="contact_person" class="form-label">Contact Person</label>
                        <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="e.g., John Smith">
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="phone_number" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" id="phone_number" name="phone_number" placeholder="e.g., +1 (555) 123-4567">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="e.g., info@supplier.com">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-plus-circle me-2"></i> Add Supplier</button>
