...
<head>
    ...
    <title>Edit User - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Edit User</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="user-form-card">
                ...
                <form action="process_edit_user.php" method="POST"> <!-- Action should point to a PHP script that processes the update -->
                    <!-- Hidden input for user ID to identify which user is being edited -->
                    <input type="hidden" name="user_id" value="1"> <!-- Replace with dynamic PHP value e.g., <?php echo htmlspecialchars($user['user_id']); ?> -->

                    <div class="mb-3">
                        <label for="username" class="form-label">Username <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="username" name="username" placeholder="Enter username" value="admin_user" required> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter email address" value="admin@pos.com" required> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter full name" value="Administrator User"> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="role" name="role" required>
                                ...
                                <option value="admin" selected>Admin</option> <!-- Select dynamically with PHP -->
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-save me-2"></i> Update User</button>
