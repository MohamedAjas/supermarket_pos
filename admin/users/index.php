...
<head>
    ...
    <title>User Management - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <!-- Custom CSS for Admin Dashboard (reused from index.php for consistency) -->
    <style>
        body {
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">User Management</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="user-table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3>All Users</h3>
                    <a href="add.php" class="btn btn-add-user">
