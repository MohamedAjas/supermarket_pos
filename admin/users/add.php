...
<head>
    ...
    <title>Add New User - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Add New User</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="user-form-card">
                ...
                <form action="process_add_user.php" method="POST"> <!-- Action should point to a PHP script that processes the form -->
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-user-plus me-2"></i> Add User</button>
