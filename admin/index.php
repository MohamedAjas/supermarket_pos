            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card text-center">
                        ...
                        <p class="card-text">Total revenue generated today.</p>
                    </div>
                </div>
                <!-- Total Products Card -->
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card text-center">
                        ...
                        <p class="card-value">5,200</p>
                        <p class="card-text">Number of unique items in stock.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card text-center">
                        ...
                        <p class="card-text">Items below minimum stock level.</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card text-center">
                        ...
                        <p class="card-text">Currently active seller accounts.</p>
                    </div>
                </div>
                <!-- Pending Orders Card (If applicable) -->
                <div class="col-md-6 col-lg-4">
                    <div class="dashboard-card text-center">
                        <i class="fas fa-hourglass-half card-icon"></i>
                        <h5 class="card-title">Pending Orders</h5>
                        <p class="card-value">3</p>
                        <p class="card-text">Orders awaiting processing.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="dashboard-card">
                        ...
                        <p class="card-text">A quick glance at the latest transactions.</p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Sale #001234 - $55.00 <span class="badge bg-success">Completed</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Sale #001233 - $120.50 <span class="badge bg-success">Completed</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Sale #001232 - $30.25 <span class="badge bg-success">Completed</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                Sale #001231 - $8.75 <span class="badge bg-success">Completed</span>
                            </li>
                        </ul>
                    </div>
                </div>
