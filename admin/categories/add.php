...
<head>
    ...
    <title>Add New Category - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Add New Category</a>
                <ul class="navbar-nav">
        ...
        <!-- Add New Category Form Content -->
        <div class="container-fluid">
            <div class="category-form-card">
                <h3 class="mb-4">Category Details</h3>
                <form action="process_add_category.php" method="POST"> <!-- Action should point to a PHP script that processes the form -->
                    <div class="mb-3">
                        <label for="category_name" class="form-label">Category Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="category_name" name="category_name" placeholder="e.g., Dairy Products" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-plus-circle me-2"></i> Add Category</button>
