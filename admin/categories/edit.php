...
<head>
    ...
    <title>Edit Category - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Edit Category</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="category-form-card">
                <h3 class="mb-4">Edit Category Details</h3>
                <form action="process_edit_category.php" method="POST"> <!-- Action should point to a PHP script that processes the update -->
                    <!-- Hidden input for category ID to identify which category is being edited -->
                    <input type="hidden" name="category_id" value="1"> <!-- Replace with dynamic PHP value e.g., <?php echo htmlspecialchars($category['category_id']); ?> -->

                    <div class="mb-3">
                        <label for="category_name" class="form-label">Category Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="category_name" name="category_name" placeholder="e.g., Dairy Products" value="Fruits" required> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter category description">Fresh fruits from various origins.</textarea> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-save me-2"></i> Update Category</button>
