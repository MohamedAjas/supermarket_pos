...
<head>
    ...
    <title>Category Management - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <style>
        ...
        /* Custom Styles for Category Table */
        .category-table-card {
            background-color: #ffffff;
            border-radius: 1rem;
            padding: 1.5rem;
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Category Management</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="category-table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="add.php" class="btn btn-add-category">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <input type="text" class="form-control form-control-sm" placeholder="Search categories by name or description...">
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>1</td>
                                <td>Fruits</td>
                                <td>Fresh fruits from various origins.</td>
                                <td><span class="badge bg-success">Active</span></td>
                                <td>
                                    <a href="edit.php?id=1" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Deactivate</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Vegetables</td>
                                <td>Organic and conventional vegetables.</td>
                                <td><span class="badge bg-success">Active</span></td>
                                <td>
                                    <a href="edit.php?id=2" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Deactivate</button>
                                </td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Dairy & Eggs</td>
                                <td>Milk, cheese, yogurt, and fresh eggs.</td>
                                <td><span class="badge bg-success">Active</span></td>
                                <td>
                                    <a href="edit.php?id=3" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Deactivate</button>
                                </td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>Bakery</td>
                                <td>Freshly baked bread, pastries, and cakes.</td>
                                <td><span class="badge bg-warning text-dark">Inactive</span></td>
                                <td>
                                    <a href="edit.php?id=4" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Activate</button>
                                </td>
                            </tr>
