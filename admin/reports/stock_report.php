...
<head>
    ...
    <title>Stock Report - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Stock Report</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="report-table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="index.php" class="btn btn-back"><i class="fas fa-arrow-left me-2"></i> Back to Reports</a>
                </div>

                <!-- Filters Applied (Dynamic content from PHP) -->
                <div class="mb-4">
                    <h5>Filters Applied:</h5>
                    <p class="mb-1"><strong>Category:</strong> Fruits</p> <!-- Example: replace with <?php echo htmlspecialchars($category_name); ?> or "All Categories" -->
                    <p class="mb-1"><strong>Supplier:</strong> Supplier A</p> <!-- Example: replace with <?php echo htmlspecialchars($supplier_name); ?> or "All Suppliers" -->
                    <p class="mb-0"><strong>Stock Status:</strong> Low Stock</p> <!-- Example: replace with <?php echo htmlspecialchars($stock_status); ?> or "All Statuses" -->
                </div>

                <!-- Summary Cards -->
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Total Unique Items</p>
                            <h4 class="summary-value">5,200</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Total Quantity in Stock</p>
                            <h4 class="summary-value">15,000 pcs</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Items Below Min Stock</p>
                            <h4 class="summary-value">15</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <!-- Example Data - In a real app, this would be dynamically loaded from PHP -->
                            <tr>
                                <td>102</td>
                                <td>Organic Milk (1L)</td>
                                <td>Dairy</td>
                                <td>Dairy Delights Co.</td>
                            ...
                            <tr>
                                ...
                                <td>Avocados (Hass)</td>
                                <td>Fruits</td>
                                <td>Fresh Harvest Farms</td>
                                <td><span class="badge bg-warning text-dark">8</span></td>
                                <td>10</td>
                                <td><span class="badge bg-warning text-dark">Low Stock</span></td>
                            </tr>
                            <!-- More stock records would be added dynamically here -->
                        </tbody>
                    </table>
                </div>
            </div>
