...
<head>
    ...
    <title>Sales Report - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Sales Report</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="report-table-card">
                ...
                <div class="mb-4">
                    ...
                    <p class="mb-1"><strong>Date Range:</strong> 2024-05-01 to 2024-05-31</p> <!-- Example: replace with <?php echo htmlspecialchars($start_date); ?> to <?php echo htmlspecialchars($end_date); ?> -->
                    <p class="mb-0"><strong>Seller:</strong> John Doe</p> <!-- Example: replace with <?php echo htmlspecialchars($seller_name); ?> or "All Sellers" -->
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Total Revenue</p>
                            <h4 class="summary-value">$15,678.90</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Total Sales Count</p>
                            <h4 class="summary-value">125</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="report-summary-card text-center">
                            <p class="summary-item mb-2">Average Sale Value</p>
                            <h4 class="summary-value">$125.43</h4> <!-- Replace with PHP data -->
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>#001230</td>
                                <td>2024-05-31 14:30</td>
                                <td>$55.00</td>
                                <td>$60.00</td>
                                <td>$5.00</td>
                                <td>Cash</td>
                                <td>John Doe</td>
                                <td><a href="#" class="btn btn-sm btn-info text-white"><i class="fas fa-info-circle"></i> View</a></td>
                            </tr>
                            <tr>
                                <td>#001229</td>
                                <td>2024-05-31 11:15</td>
                                <td>$120.50</td>
                                <td>$120.50</td>
                                <td>$0.00</td>
                                <td>Card</td>
                            ...
                            <!-- More sales records would be added dynamically here -->
                        </tbody>
                    </table>
                </div>
            </div>
