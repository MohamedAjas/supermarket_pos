...
<head>
    ...
    <title>Add New Item - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Add New Item</a>
                <ul class="navbar-nav">
        ...
        <!-- Add New Item Form Content -->
        <div class="container-fluid">
            <div class="item-form-card">
                <h3 class="mb-4">Item Details</h3>
                <form action="process_add_item.php" method="POST" enctype="multipart/form-data"> <!-- Add enctype for file upload -->
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="item_name" class="form-label">Item Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="item_name" name="item_name" placeholder="e.g., Fresh Red Apples" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="sku" class="form-label">SKU</label>
                            <input type="text" class="form-control" id="sku" name="sku" placeholder="e.g., FRDA123">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="barcode" class="form-label">Barcode</label>
                            <input type="text" class="form-control" id="barcode" name="barcode" placeholder="e.g., 123456789012">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control" id="price" name="price" placeholder="e.g., 2.99" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="cost_price" class="form-label">Cost Price ($)</label>
                            <input type="number" step="0.01" min="0" class="form-control" id="cost_price" name="cost_price" placeholder="e.g., 1.50">
                            <small class="form-text text-muted">Used for profit calculation.</small>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="stock_quantity" class="form-label">Stock Quantity <span class="text-danger">*</span></label>
                            <input type="number" min="0" class="form-control" id="stock_quantity" name="stock_quantity" placeholder="e.g., 100" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" min="0" class="form-control" id="min_stock_level" name="min_stock_level" placeholder="e.g., 10">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">Upload an image for the item (Max 2MB).</small>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-plus-circle me-2"></i> Add Item</button>
