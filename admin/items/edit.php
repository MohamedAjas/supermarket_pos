...
<head>
    ...
    <title>Edit Item - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <style>
        ...
        .item-form-card {
            ...
            border: none;
            max-width: 900px; /* Adjust width for item form as it has more fields */
        ...
        .btn-submit {
            background-color: #FFD700; /* Gold for submit */
            border-color: #FFD700;
            color: #333;
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Edit Item</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="item-form-card">
                <h3 class="mb-4">Edit Item Details</h3>
                <form action="process_edit_item.php" method="POST" enctype="multipart/form-data"> <!-- Add enctype for file upload -->
                    <!-- Hidden input for item ID to identify which item is being edited -->
                    <input type="hidden" name="item_id" value="101"> <!-- Replace with dynamic PHP value e.g., <?php echo htmlspecialchars($item['item_id']); ?> -->

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="item_name" class="form-label">Item Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="item_name" name="item_name" placeholder="e.g., Fresh Red Apples" value="Fresh Red Apples" required> <!-- Replace with dynamic PHP value -->
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="sku" class="form-label">SKU</label>
                            <input type="text" class="form-control" id="sku" name="sku" placeholder="e.g., FRDA123" value="FAPPLERED"> <!-- Replace with dynamic PHP value -->
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="barcode" class="form-label">Barcode</label>
                            <input type="text" class="form-control" id="barcode" name="barcode" placeholder="e.g., 123456789012" value="123456789012"> <!-- Replace with dynamic PHP value -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="category_id" name="category_id" required>
                                ...
                                <option value="1" selected>Fruits</option> <!-- Select dynamically with PHP -->
                                <option value="2">Vegetables</option>
                                <option value="3">Dairy & Eggs</option>
                                <option value="4">Bakery</option>
                                <option value="5">Beverages</option>
                                <!-- Categories would be dynamically loaded from the database -->
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="supplier_id" name="supplier_id" required>
                                ...
                                <option value="1" selected>Supplier A</option> <!-- Select dynamically with PHP -->
                                <option value="2">Supplier B</option>
                                <option value="3">Supplier C</option>
                                <!-- Suppliers would be dynamically loaded from the database -->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control" id="price" name="price" placeholder="e.g., 2.99" value="2.99" required> <!-- Replace with dynamic PHP value -->
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="cost_price" class="form-label">Cost Price ($)</label>
                            <input type="number" step="0.01" min="0" class="form-control" id="cost_price" name="cost_price" placeholder="e.g., 1.50" value="1.50"> <!-- Replace with dynamic PHP value -->
                            <small class="form-text text-muted">Used for profit calculation.</small>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="stock_quantity" class="form-label">Stock Quantity <span class="text-danger">*</span></label>
                            <input type="number" min="0" class="form-control" id="stock_quantity" name="stock_quantity" placeholder="e.g., 100" value="150" required> <!-- Replace with dynamic PHP value -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" min="0" class="form-control" id="min_stock_level" name="min_stock_level" placeholder="e.g., 10" value="10"> <!-- Replace with dynamic PHP value -->
                            <small class="form-text text-muted">Alert when stock falls below this level.</small>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="status" class="form-label">Status <span class="text-danger">*</span></label>
                            <select class="form-select" id="status" name="status" required>
                                <option value="active" selected>Active</option> <!-- Select dynamically with PHP -->
                    ...
                    <div class="mb-3">
                        <label for="current_image" class="form-label">Current Item Image</label>
                        <div>
                            <img src="https://placehold.co/100x100/e0e5ec/343a40?text=Item" alt="Current Item Image" class="rounded mb-2" style="max-width: 100px; height: auto;"> <!-- Replace with dynamic PHP image path -->
                        </div>
                        <label for="item_image" class="form-label">Change Item Image</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter item description">Delicious, crisp red apples, perfect for snacking or baking.</textarea> <!-- Replace with dynamic PHP value -->
                    </div>

                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-save me-2"></i> Update Item</button>
                        <a href="index.php" class="btn btn-cancel"><i class="fas fa-times-circle me-2"></i> Cancel</a>
                    </div>
                </form>
            </div>
        </div>
