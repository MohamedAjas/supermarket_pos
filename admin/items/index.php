...
<head>
    ...
    <title>Item Management - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Item Management</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="item-table-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3>All Items</h3>
                    <a href="add.php" class="btn btn-add-item">
                ...
                <div class="row mb-3">
                    <div class="col-md-5">
                        <input type="text" class="form-control form-control-sm" placeholder="Search items by name, SKU, or barcode...">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <select class="form-select form-select-sm">
                            ...
                            <!-- More suppliers would be dynamically loaded -->
                        </select>
                    </div>
                    <div class="col-md-2">
                        <select class="form-select form-select-sm">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>101</td>
                                <td><img src="https://placehold.co/50x50/e0e5ec/343a40?text=Item" alt="Item Image" class="rounded"></td>
                                <td>Fresh Apples (Red)</td>
                                <td>Fruits</td>
                                <td>FAPPLERED</td>
                                <td>$2.99</td>
                                ...
                                <td>
                                    <a href="edit.php?id=101" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?id=102" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Deactivate</button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?id=103" class="btn btn-action btn-edit"><i class="fas fa-edit"></i> Edit</a>
                                    <button type="button" class="btn btn-action btn-delete"><i class="fas fa-trash-alt"></i> Deactivate</button>
                                </td>
                            </tr>
