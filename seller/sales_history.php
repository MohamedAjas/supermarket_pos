...
<head>
    ...
    <title>Sales History - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <!-- Custom CSS for Seller Sales History (consistent with other seller pages) -->
    <style>
        body {
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">Sales History</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="sales-history-card">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <input type="text" class="form-control form-control-sm" placeholder="Search by Sale ID or item...">
                    </div>
                    <div class="col-md-4">
                        <input type="date" class="form-control form-control-sm" placeholder="Filter by Date">
                    </div>
                    <div class="col-md-4">
                        <select class="form-select form-select-sm">
                            <option selected>Filter by Payment Method</option>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>#SELLER001</td>
                                <td>2024-06-14 10:30 AM</td>
                                <td>$55.00</td>
                                <td>3</td>
                                <td>Cash</td>
                                <td><button type="button" class="btn btn-view-details"><i class="fas fa-eye"></i> View Details</button></td>
                            </tr>
                            <tr>
                                <td>#SELLER002</td>
                                <td>2024-06-13 02:15 PM</td>
                                <td>$120.50</td>
                                <td>5</td>
                                <td>Card</td>
                                <td><button type="button" class="btn btn-view-details"><i class="fas fa-eye"></i> View Details</button></td>
