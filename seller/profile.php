...
<head>
    ...
    <title>My Profile - Supermarket POS</title>
    <!-- Google Fonts: Inter -->
    ...
    <!-- Custom CSS for Seller Profile (consistent with other seller pages) -->
    <style>
        body {
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <nav class="navbar navbar-top navbar-expand-lg">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto" href="#">My Profile</a>
                <ul class="navbar-nav">
        ...
        <div class="container-fluid">
            <div class="profile-form-card">
                <h3 class="mb-4">My Profile Details</h3>
                <form action="process_profile_update.php" method="POST"> <!-- Action should point to a PHP script that processes the update -->
                    <div class="mb-3">
                        <label for="username" class="form-label">Username</label>
                        <input type="text" class="form-control" id="username" name="username" value="seller_user" disabled> <!-- Username typically not editable directly -->
                        <small class="form-text text-muted">Username cannot be changed.</small>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email address" value="seller@pos.com" required> <!-- Replace with dynamic PHP value -->
                    </div>
                    <div class="mb-3">
                        <label for="full_name" class="form-label">Full Name</label>
                        <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter your full name" value="Seller John Doe"> <!-- Replace with dynamic PHP value -->
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <button type="submit" class="btn btn-submit"><i class="fas fa-save me-2"></i> Save Changes</button>
    ...
    <script>
        // JavaScript for sidebar toggling and responsiveness (reused from common header/footer logic)
