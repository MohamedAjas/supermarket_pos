<?php
/**
 * seller/includes/footer.php
 * This file contains the common closing HTML tags and JavaScript includes
 * for all seller panel pages in the Supermarket POS system.
 */
?>
        </div> <!-- Closes .main-content -->
    </div> <!-- Closes .main-content-wrapper (if there was one, otherwise this might be redundant based on specific page structure) -->

    <!-- Bootstrap JS Bundle with Popper -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" xintegrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <script>
        // JavaScript for sidebar toggling and responsiveness
